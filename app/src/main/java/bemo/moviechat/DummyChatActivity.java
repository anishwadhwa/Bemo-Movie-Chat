...
import bemo.moviechat.models.ChatMessage;
...
public class DummyChatActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rl_chat_full)
    RelativeLayout rlChatFull;

    private FirebaseListAdapter<ChatMessage> adapter;
    public final int SIGN_IN_REQUEST_CODE = 101;
    @Override
    ...
    public void onViewClicked() {
        ...
        FirebaseDatabase.getInstance()
                .getReference()
                .push()
                .setValue(new ChatMessage(etChatInput.getText().toString(),
